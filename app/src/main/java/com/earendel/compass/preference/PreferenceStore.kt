...
package com.earendel.compass.preference
...
class PreferenceStore(context: Context, lifecycle: Lifecycle) {
    ...
    val isRotationEnabled = MutableLiveData<Boolean>()
    ...
    private val isRotationEnabledObserver = getIsRotationEnabledObserver()
    ...
    private inner class PreferenceStoreLifecycleObserver : DefaultLifecycleObserver {
        ...
        override fun onCreate(owner: LifecycleOwner) {
            ...
            isRotationEnabled.observeForever(isRotationEnabledObserver)
        ...
        override fun onDestroy(owner: LifecycleOwner) {
            ...
            isRotationEnabled.removeObserver(isRotationEnabledObserver)
    ...
    private inner class SharedPreferenceChangeListener : SharedPreferences.OnSharedPreferenceChangeListener {
        override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String?) {
            when (key) {
                ...
                PreferenceConstants.IS_ROTATION_ENABLED -> updateIsRotationEnabled()
    ...
    private fun updateIsRotationEnabled() {
        val storedValue = sharedPreferences.getBoolean(PreferenceConstants.IS_ROTATION_ENABLED, true)
        if (isRotationEnabled.value != storedValue) {
            isRotationEnabled.value = storedValue
        }
    }
    ...
    private fun getIsRotationEnabledObserver(): (t: Boolean) -> Unit = {
        sharedPreferences.edit {
            putBoolean(PreferenceConstants.IS_ROTATION_ENABLED, it)
        }
        Log.d(TAG, "Persisted isRotationEnabled: $it")
    }
